        ...
        ">
            ...
            <div style="{_ROW_STYLE}">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 14px; color: #4A4A4A;">
                        All document types: PDF, DOCX, PPTX, XLSX, HTML, CSV, JSON, XML, EPUB, images, ZIP
                    </div>
                </div>
            </div>
            ...
            <div style="{_ROW_STYLE} border-bottom: none;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 14px; color: #4A4A4A;">
                        C/C++ source &amp; headers: <code>.h .hpp .hh .hxx .cpp .cc .cxx .c</code>
                        — extracts <code>/** */</code> doc comments; falls back to fenced code block
                    </div>
                </div>
            </div>
        </div>
